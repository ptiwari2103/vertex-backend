    ...
    async (req, res) => {
        try {
            ...
            const updateData = {
                aadhar_number: req.body.aadhar_number,
                pan_number: req.body.pan_number,
                aadhar_number_image_front: req.files.aadhar_front[0].path.replace(/\\/g, '/'),
                aadhar_number_image_back: req.files.aadhar_back[0].path.replace(/\\/g, '/'),
                pan_number_image: req.files.pan_front[0].path.replace(/\\/g, '/'),
